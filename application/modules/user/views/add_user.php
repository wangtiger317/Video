            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" name="phone_number"
                           value="<?php echo isset($userData->phone_number) ? $userData->phone_number : ''; ?>" class="form-control"
            ...
            <div class="col-md-12">
                <div class="form-group imsize">
                    ...
                    <div class="pic_size" id="image-holder">
                        <?php if (isset($userData->profile_pic) && file_exists('assets/images/demo/' . $userData->profile_pic)) {
                            $profile_pic = $userData->profile_pic;
                        } else {
                            $profile_pic = 'user.png';
                        } ?>
                        <left><img class="thumb-image setpropileam"
                                   src="<?php echo base_url(); ?>/assets/images/demo/<?php echo isset($profile_pic) ? $profile_pic : 'user.png'; ?>"
