...
//session_start();
//if(1){
//    setcookie("agecheck", "true", time()+60*60*24*7); // Remember answer for 7 days
    ...
    <div class="d-flex justify-content-center h-100">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <?php } ?>
                <form method="POST" action="<?php echo base_url().'user/auth_user'; ?>">
            ...
            <div class="text-center">
                <a href="<?php echo base_url().'signup';?>" style="color:yellow">NewUser?</a>
            </div>
            <div class="card-footer">
                <div class="justify-content-center links text-center">
                    Accept <a href="<?php echo base_url().'termsofuse';?>">Terms of use</a> and <a href="<?php echo base_url().'privacypolicy';?>">Privacy Policy</a>
                </div>
            </div>
        </div>
    </div>
