        ...
        <div class="flexslider progression-studios-dashboard-slider progression-studios-full-height-slider">
            <ul class="slides">
                <li class="progression_studios_animate_left">
                    <div class="progression-studios-slider-dashboard-image-background" style="background-image:url('<?php echo base_url('assets/images/banners/10.jpg')?>');">
...
<!--                                            </ul>-->
<!--                                            <h2><a href="--><?php //echo base_url().'user/movieprofile'?><!--">Transformers: The Last Knight</a></h2>-->
...
<!--                                                single New Yorkers.</p>-->
                ...
                <li class="progression_studios_animate_in">
                    <div class="progression-studios-slider-dashboard-image-background" style="background-image:url('<?php echo base_url('assets/images/banners/7.jpg')?>');">
                        <div class="progression-studios-slider-display-table">
                            <div class="progression-studios-slider-vertical-align">
