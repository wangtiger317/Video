...
<div class="wrapper">
                        ...
                        <div class="box-header with-border">
                            ...
                            <div class="box-tools">
                                <?php if (CheckPermission("users", "own_create")) { ?>
                                    <button type="button" class="btn-sm  btn btn-success modalButtonMovie"
                                            data-toggle="modal"><i class="glyphicon glyphicon-plus"></i> Add Movie
                                    </button>
                                <?php }
    ...
    <!-- Modal Crud Start-->
    <div class="modal fade" id="nameModal_movie" role="dialog">
