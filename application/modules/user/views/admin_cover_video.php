                        ...
                        <div class="box-body">
                            <div class="col-md-12">
                                <div class="form-group imsize">
                                    <?php $video = ''?>
                                    <?php if (isset($cover_video) && file_exists('assets/' . $cover_video)) {
                                        $video = $cover_video;
                                    } ?>
                                    <video id="cover_video" width="640" height="360" controls>
                                        <source src="<?php echo base_url().'assets/'.$cover_video; ?>"
                                                type="video/mp4"/>
                                    </video>
...
<script>
    $(document).ready(function(){
        $("#exampleInputFile").change(function () {
            ...
            $.ajax({
                url: '<?php echo base_url();?>user/covervideoupload', // point to server-side PHP script
                ...
                success: function(php_script_response){
                    var path = "<?php echo base_url(); ?>" + "assets/" + php_script_response;
                    // alert(php_script_response); // display response from the PHP script, if any
                    $("#cover_video").attr("src", path);
                }
            });
        });
    });
