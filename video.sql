...
INSERT INTO `movies` (`id`, `title`, `cost`, `image`, `banner_image`, `video`, `type`, `rating`, `length`, `director`, `brief_content`) VALUES
(1, 'The Wild Things Are', NULL, '11.jpg', '1.jpg', NULL, NULL, 9, NULL, NULL, NULL),
(2, 'Central Intelligence', NULL, '9.jpg', '1.jpg', NULL, NULL, 6, NULL, NULL, NULL),
(3, 'Zoolander No. 2', NULL, '4.jpg', '1.jpg', NULL, NULL, 8.6, NULL, NULL, NULL),
(4, 'Bad Neighbors 2', NULL, '5.jpg', '1.jpg', NULL, NULL, 7.2, NULL, NULL, NULL),
(5, 'Star Wars', NULL, '7.jpg', '1.jpg', NULL, NULL, 8.6, NULL, NULL, NULL),
(6, 'The Imitation Game', NULL, '8.jpg', '1.jpg', NULL, NULL, 6, NULL, NULL, NULL),
(7, 'Fantastic Beasts', NULL, '6.jpg', '1.jpg', NULL, NULL, 8.6, NULL, NULL, NULL),
(8, 'Edge of Tomorrow', NULL, '2.jpg', '1.jpg', NULL, NULL, 7.2, NULL, NULL, NULL),
(9, 'Allegiant', NULL, '12.jpg', '1.jpg', NULL, NULL, 8.6, NULL, NULL, NULL),
(10, 'Lo and Behold', NULL, '1.jpg', '1.jpg', NULL, NULL, 6, NULL, NULL, NULL),
(11, 'Drive', NULL, '10.jpg', '1.jpg', NULL, NULL, 8.6, NULL, NULL, NULL),
(12, 'Nightcrawler', NULL, '3.jpg', '1.jpg', NULL, NULL, 7.2, NULL, NULL, NULL);
...
INSERT INTO `reviews` (`id`, `movie_id`, `comments`, `author`, `created_at`) VALUES
(9, 1, '<p>This is a fantastic film.</p>\r\n', 'Suzie Smith', '2019-11-22'),
(10, 1, '<p>Another good experience..</p>\r\n', 'Suzie Smith', '2019-11-22'),
(11, 2, '<p>The best film ever.</p>\r\n', 'Suzie Smith', '2019-11-23');
...
INSERT INTO `users` (`users_id`, `user_id`, `var_key`, `status`, `is_deleted`, `name`, `password`, `email`, `phone_number`, `profile_pic`, `user_type`, `country`) VALUES
(1, '1', '', 'active', '0', 'Admin', '$2y$10$M3balQeXT7vqj/Do8.xMieVvK1JjJ0RzeDel51E5rgMNuLdzsf8/a', 'admin@gmail.com', '18359741075', 'account-profile.jpg', 'admin', 'Malaysia'),
(8, '2', '', 'active', '0', 'Suzie Smith', '$2y$10$M3balQeXT7vqj/Do8.xMieVvK1JjJ0RzeDel51E5rgMNuLdzsf8/a', 'test@gmail.com', '18359741075', 'account-profile.jpg', 'Member', 'Malaysia');
...
--
ALTER TABLE `movies`
  MODIFY `id` int(121) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
...
--
ALTER TABLE `reviews`
  MODIFY `id` int(121) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
